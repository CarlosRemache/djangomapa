"""
Django settings for geografica project.
...
STATIC_URL = '/static/'
STATICFILES_DIRS=(os.path.join(BASE_DIR,'geografica/static'),)
...
MEDIA_URL='/media/'
MEDIA_ROOT=(os.path.join(BASE_DIR,'geografica/media/'))
